...
global.sgc = 'https://chat.whatsapp.com/Bmb4I127aL7JNS3YS0VnKb'
...
/*============== NOMOR ==============*/
global.nomorbot = '6285602841574' //Nomor Bot
global.nomorown = '6281251051640' //Nomor Owner
global.namebot = 'ᴢᴀʟʟ ʙᴏᴛ' //Nama Bot
global.nameown = 'ᴢᴀʟʟ sᴛᴏʀᴇ' // Nama Owner


/*============== STAFF ==============*/
global.owner = [
  ['6281251051640', 'ᴢᴀʟʟ sᴛᴏʀᴇ', true] //Ganti jd nomormu sama Namamu
...
/*============== WATERMARK ==============*/
global.wm = '                「 ᴢᴀʟʟ ʙᴏᴛ 」' //Main Watermark
global.wm2 = 'ᴢᴀʟʟ ʙᴏᴛ'
global.wm3 = '⫹⫺ ᴢᴀʟʟ ʙᴏᴛ'
global.namedoc = 'ᴢᴀʟʟ ʙᴏᴛ' //Main Name Menu Document
global.botdate = `⫹⫺ Day's: ${week} ${date}`
global.bottime = `ᴛɪᴍᴇ: ${wktuwib}`
global.titlebot = 'ᴢᴀʟʟ ʙᴏᴛ'
...
global.packname = 'Sticker Request By ᴢᴀʟʟ ʙᴏᴛ'
global.packname2 = 'ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴢᴀʟʟ ʙᴏᴛ'
